    ...
    <main className="min-h-screen bg-white text-black overflow-hidden">
      <nav className="fixed top-0 left-0 w-full z-50 bg-white/80 backdrop-blur-md border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-8 py-3 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-5">
            <a href="https://github.com/asharma8924" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <FaGithub className="text-3xl text-black" />
              <span className="text-sm mt-1 text-gray-700">GitHub</span>
            </a>

            <a href="https://www.linkedin.com/in/angad-sharma-0818a0193/" target="_blank" rel="noopener noreferrer" className="flex flex-col items-center">
              <FaLinkedin className="text-3xl text-[#0077B5]" />
              <span className="text-sm mt-1 text-gray-700">LinkedIn</span>
            </a>

            <a href="mailto:angads2005@gmail.com" className="flex flex-col items-center">
        ...
        {menuOpen && (
          <div className="md:hidden flex flex-col gap-4 px-8 pb-5 bg-white text-gray-700 font-medium shadow-md">
            <a href="#about" onClick={() => setMenuOpen(false)}>About</a>
            <a href="#experience" onClick={() => setMenuOpen(false)}>Experience</a>
            <a href="#skills" onClick={() => setMenuOpen(false)}>Skills</a>
            <a href="#projects" onClick={() => setMenuOpen(false)}>Projects</a>
            <a href="https://github.com/asharma8924" target="_blank" rel="noopener noreferrer">GitHub</a>
            <a href="https://www.linkedin.com/in/angad-sharma-0818a0193/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
            <a href="mailto:angads2005@gmail.com">Email</a>
          </div>
        )}
      </nav>
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-10 text-black">Experience</h2>
        </div>
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-300 text-lg">What I have learned over the years.</p>
          </div>

          <div className="space-y-14">
            {skillCategories.map((category) => (
              <div key={category.title}>
                <h3 className="text-3xl font-bold mb-8 text-white">{category.title}</h3>
      ...
      >
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-10 text-black">Projects</h2>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.7 }}
              className="rounded-3xl border border-gray-200 bg-white shadow-lg p-8 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,0,0,0.15)] transition duration-300"
            >
              <div className="h-2 w-20 rounded-full bg-black mb-6" />

              <h3 className="text-2xl font-semibold mb-3 text-black">
                <a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 hover:underline">
                  {project.title}
              ...
              <p className="text-gray-700 leading-7 mb-6">{project.description}</p>

              <a href={project.github} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-medium text-black hover:underline">
      ...
      >
        <div className="rounded-3xl bg-white border border-gray-200 shadow-lg p-10 text-center">
          ...
          <a href="mailto:angads2005@gmail.com" className="inline-block rounded-xl bg-black text-white px-6 py-3 font-semibold hover:scale-105 transition">
            Email Me
          </a>
        </div>
      </motion.section>
